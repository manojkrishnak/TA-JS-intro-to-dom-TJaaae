...
console.log(`label count: ${document.querySelectorAll("label").length}`)
...
topics[0].children[0].innerText = "dken"
// 25. Select the last element child of the element stored in `topics` variable (#5) and log the `typeof` the element.
console.log(typeof topics[0].children[topics[0].children.length -1])
